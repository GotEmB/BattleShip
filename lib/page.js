...
var bindMouseDown, easeInOut, setupCanvas, setupEvents, setupPage, viewport, wdp, _ref;
...
setupEvents = function() {
  bindMouseDown("#newGame_btn", function(e) {
    ...
    return $("#newMenu").removeClass("moveRight");
  });
  return bindMouseDown("#joinGame_btn", function(e) {
    $("#menuView").addClass("enableTransitions");
    $("#mainMenu").addClass("moveLeft");
