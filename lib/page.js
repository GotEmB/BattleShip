...
var async, bindMouseDown, easeInOut, gotoGameOverMenu, hideFriendPlacingMenu, pleaseWait, roundTo1, setupCanvas, setupEvents, setupGame, setupPage, showFriendPlacingMenu, socket, viewport, wdp, _ref;
...
setupCanvas = function(data) {
  var Game, activateMine, activateYours, activeTool, canvasThis, inactiveTool, mainLayer, makeShip, myTurn, yourTurn,
    _this = this;
  canvasThis = this;
  ...
  activeTool = new Tool();
  activeTool.onMouseUp = function(e) {};
  myTurn = function() {
  ...
  socket.on("shotAt", function(data) {});
  return view.draw();
};
