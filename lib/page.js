...
setupCanvas = function(data) {
  ...
  (function() {
    ...
    shipMover = (function() {
      ...
      shipMover.moveto = function(endPos, force) {
        var delta, startPos;
    ...
    tool.onMouseDrag = function(e) {
      ...
      if (delta.x >= 30 * wdp) moveBy([30 * wdp, 0]);
      if (delta.x <= -30 * wdp) moveBy([-30 * wdp, 0]);
      if (delta.y >= 30 * wdp) moveBy([0, 30 * wdp]);
      if (delta.y <= -30 * wdp) return moveBy([0, -30 * wdp]);
    };
