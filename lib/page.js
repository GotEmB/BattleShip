...
setupCanvas = function(data) {
  var activateMine, activateYours, mainLayer,
    _this = this;
  ...
  (function() {
    var mine, mineBack, mineFront, mineGrid, mine_p;
    mineBack = new Layer();
    mainLayer.activate();
    ...
    _this.mine_s = new Symbol(mine);
    return mine_p = _this.mine_s.place([160 * wdp, 160 * wdp]);
  })();
  (function() {
    var yours, yoursBack, yoursFront, yoursGrid;
    yoursBack = new Layer();
    mainLayer.activate();
    ...
    return _this.yours_s = new Symbol(yours);
  })();
  (function() {
    var arc, arrow, box, rotate, rotate_p;
    ...
    _this.rotate_s.mouseUp = function() {
      box.fillColor = "white";
      arc.strokeColor = "black";
      return arrow.fillColor = "black";
    };
    return rotate_p = _this.rotate_s.place([295 * wdp, 335 * wdp]);
  })();
